                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Container(
                          margin: const EdgeInsets.only(top: 4, left: 155),
                          child: SvgPicture.asset(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Container(
                          margin: const EdgeInsets.only(top: 4, left: 154),
                          child: SvgPicture.asset(
                            "assets/vectors/ic_chevron-right.svg",
                            width: 18, // Chiều rộng của icon
                            height: 20, // Chiều cao của icon
                        ...
                        Positioned(
                          child: Row(
                            children: [
                              ...
                              Container(
                                margin:
                                    const EdgeInsets.only(top: 4, left: 196),
                                child: SvgPicture.asset(
                                  "assets/vectors/ic_chevron-right.svg",
                                  width: 18, // Chiều rộng của icon
                                  height: 20, // Chiều cao của icon
                        ...
                        Positioned(
                          child: Row(
                            children: [
                              ...
                              Container(
                                margin:
                                    const EdgeInsets.only(top: 4, left: 162),
                                child: SvgPicture.asset(
                                  "assets/vectors/ic_chevron-right.svg",
                                  width: 18,
                                  height: 20,
